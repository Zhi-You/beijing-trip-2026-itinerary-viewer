...
export const PLACE_COORDINATES: Record<string, Coordinates> = {
  ...
  'raffles-city-popup': { lat: 39.9408, lng: 116.4355 },
  'guomao-popup': { lat: 39.9092, lng: 116.4583 },
...
export const AREA_COORDINATES: Record<string, Coordinates> = {
  ...
  'Raffles City': { lat: 39.9408, lng: 116.4355 },
  '来福士': { lat: 39.9408, lng: 116.4355 },
  '来福士中心': { lat: 39.9408, lng: 116.4355 },
  Guomao: { lat: 39.9092, lng: 116.4583 },
  '国贸': { lat: 39.9092, lng: 116.4583 },
  '国贸商城': { lat: 39.9092, lng: 116.4583 },
  'China World Mall': { lat: 39.9092, lng: 116.4583 },
...
export const POKEMON_CENTER_COORDINATES: Record<string, Coordinates> = {
  ...
  'Pokemon Pop-up · Raffles City': { lat: 39.9408, lng: 116.4355 },
  'Pokemon Pop-up · China World Mall': { lat: 39.9092, lng: 116.4583 },
  '宝可梦快闪 · 来福士中心': { lat: 39.9408, lng: 116.4355 },
  '宝可梦快闪 · 国贸商城': { lat: 39.9092, lng: 116.4583 },
  '宝可梦快闪 · 西单大悦城': { lat: 39.9097, lng: 116.3738 },
  '宝可梦快闪 · 凯德MALL望京': { lat: 39.9945, lng: 116.4738 },
};
